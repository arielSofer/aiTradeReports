      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-dark-950">
        <div className="w-full max-w-md space-y-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-dark-900 hover:bg-dark-800 
                       border border-dashed border-dark-600 rounded-lg text-dark-300 font-medium transition-colors"
          >
            Continue as Guest
          </button>
